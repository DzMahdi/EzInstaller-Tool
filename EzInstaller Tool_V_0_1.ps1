...
# Create checkboxes for Google Chrome, Microsoft Teams, and TeamViewer
...
$form.Controls.AddRange(@($checkBoxChrome, $checkBoxTeams, $checkBoxTeamViewer))
...
$installButton.Add_Click({
    ...
    if ($checkBoxChrome.Checked -or $checkBoxTeams.Checked -or $checkBoxTeamViewer.Checked) {
        $form.Close()
    }
})
